            ...
            <div className="col-md-10" style={{ height: '100vh', background: '#F4F7FC' }}>
                ...
                <form className="customFormStyle mb-5" onSubmit={handleSubmit(onSubmit)} id="myform">
                    ...
                    <div className="form-group animate__animated animate__fadeInRight">
                        <input type="text" {...register("name")} name="name" className="form-control form-control-lg" maxlength="20" placeholder="Your name" /* value={name} */ />
                        {/* {errors.name && <span className="text-danger">This field is required</span>} */}
                    </div>

                    <div className="form-group animate__animated animate__fadeInRight">
                        <input type="text" {...register("company")} name="company" className="form-control form-control-lg" maxlength="25" placeholder="Company’s name, Designation" />
                    ...
                    <div className="d-flex justify-content-between">
                        <button type="submit" className="btn btn-info btnSubmit animate__animated animate__fadeInRight" >Submit</button>
